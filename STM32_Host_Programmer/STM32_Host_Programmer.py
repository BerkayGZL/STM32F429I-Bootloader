...
def calc_file_len():
    size = os.path.getsize("mySource_App2.bin")
    return size

def open_the_file():
    global bin_file
    bin_file = open('mySource_App2.bin','rb') #rb (read binary)
    #read = bin_file.read()
...
# It is used to calculate the byte value corresponding to a particular index of the given address.
